...
@endif 
    ...
    <div class="d-flex flex-sm-row flex-column">
           ...
           <button   target="_blank"  data-bs-toggle="modal" data-bs-target="#exLargeModal" class="p-2 border text-size blue white a_hover">ព័ត៍មានអំពីស្ថានភាព</bnutton>
           
           <button  class="p-2 border text-size blue white a_hover">ប្រវត្តិការងារ</button>

           <button  class="p-2 border text-size blue white a_hover">គ្រឿងឥស្សរិយយស​​ ប័ណ្ណសរសើរ ឬទណ្ខកម្មវិន័យ</button>

           <button  class="p-2 border text-size blue white a_hover">កម្រិតវប្បធម៍ទូទៅ ការបណ្តុះបណ្តាលវិជ្ជាជីវៈ និងការបន្តុះបណ្តាលបន្ត</button>

           <button  class="p-2 border text-size blue white a_hover">សមត្ថភាពភាសាបរទេស</button>

           <button  class="p-2 border text-size blue white a_hover" >ស្ថានភាពគ្រួសា</button>
    ...
    <div class="modal fade" id="exLargeModal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-xl" role="document">
            ...
            <div class="modal-body">
                ...
                @if($id=$user->id && !empty($user_information))

                    @component('components.user.user_form_information', ['id' => $user->id, 'user_information' => $user_information,'AdditionalPositionCurrentJob'=>$AdditionalPositionCurrentJob])
                        <!-- Additional content if necessary -->
                    @endcomponent

                @else
                        
                    @component('components.user.user_form_information', ['id' => $user->id])
                        <!-- Additional content if necessary -->
                    @endcomponent
