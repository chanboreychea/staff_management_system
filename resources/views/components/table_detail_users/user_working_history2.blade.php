            ...
            <tbody>
                ...
                @if(isset($userWoringHistoryPublicSetor))
                    ...
                    <tr>
                        ...
                        <td  style="font-size:12px;text-align: justify;" ><div  style="width:70px;" >{{$row->start_date}}</div></td>
                        
                        <td   style="font-size:12px;text-align: justify;"><div style="width:70px;" >{{$row->end_date}}</div></td>
                        
                        <td  style="font-size:12px;text-align: justify;" ><div  class="container" >{{$row->ministry}}</div></td>
                        
                        <td  style="font-size:12px;text-align: justify;" ><div  class="container" >{{$row->economy}}</div></td>
                        
                        <td  style="font-size:12px;text-align: justify;" ><div   class="container" >{{$row->position}}</div></div></td>
                        
                        <td  style="font-size:12px;text-align: justify;"><div  class="container" >{{$row->other}}</div></td>
        ...
        <tbody>
            ...
            @if(isset($userWoringHistoryPrivateSetor))
                ...
                <tr>
                    ...
                    <td  style="font-size:12px" ><div class="container">{{$row->position}}</div></td>

                    <td  style="font-size:12px" ><div class="container">{{$row->tecnology}}</div></td>
                    
                    <td  style="font-size:12px" ><div class="container">{{$row->other}}</div></td>
