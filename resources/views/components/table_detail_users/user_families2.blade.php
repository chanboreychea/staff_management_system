                ...
                <table  class="table borderless" >
                    ...
                    <thead>
                        ...
                        <tr class="grid-row">
                            ...
                            <td  class="grid-cell">ទីលំនៅបច្ចុប្បន្ន<span style="margin-left:37px;">:</span> {{$userFamily->f_current_residence}}</td>
                        
                        </tr>

                        <tr class="grid-row">
                            
                            <td  class="grid-cell">មុខរបរ<span style="margin-left:76px;">:</span> {{$userFamily->father_job}}</td>
                        ...
                        <tr class="grid-row">
                            ...
                            <td  class="grid-cell">ទីលំនៅបច្ចុប្បន្ន<span style="margin-left:35px;">:</span> {{$userFamily->m_current_residence}}</td>
                        
                        </tr>

                        <tr class="grid-row">
                            
                            <td  class="grid-cell">មុខរបរ<span style="margin-left:74px;">:</span> {{$userFamily->federation_name}}</td>
