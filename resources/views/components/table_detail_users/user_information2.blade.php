        ...
        <table class="table borderless">
            ...
            <thead>
                ...
                <tr class="grid-row">
                    ...
                    <td class="grid-cell">អត្តលេខមន្ត្រីរាជការ <span style="margin-left:10px;">:</span>
                        {{ $user->idCard }}</td>
                ...
                <tr class="grid-row">
                    ...
                    <td class="grid-cell">គោត្តនាម​ និង នាម <span
                            style="margin-left:14px;">:</span>{{ $user->lastNameKh }} {{ $user->firstNameKh }}</td>
                ...
                <tr class=" grid-row1">
                    ...
                    <td class="grid-cell1">ទីកន្លែងកំណើត<span style="margin-left:36px;">:</span> {{ $user->pobAddress }}
                    </td>
                ...
                <tr class="grid-row1" width="100%">
                    ...
                    <td class="grid-cell1">អាសយដ្ខានបច្ចុប្បន្ន<span style="margin-left:15px;">:</span>
                        {{ $user->pobAddress }}</td>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell1" width="100%">អ៊ីម៉ែល<span style="margin-left:75px;">:
                        </span>{{ $user->email }}</td>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell1">លេខទូរសព្ទ<span style="margin-left:51px;">: </span>{{ $user->phoneNumber }}
                    </td>
                ...
                <tr class="grid-row">
                    ...
                    <td class="grid-cell">អត្តសញ្ញាណប័ណ្ណ<span style="margin-left:25px;">:</span> </td>
                ...
                <tr class="grid-row">
                    ...
                    <td class="grid-cell">លិខិតឆ្លងដែន<span style="margin-left:42px;">:</span> </td>
        ...
        <table class="table borderless">
            ...
            <thead>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">ក្របខណ្ឌ<span
                            style="margin-left:122px;">:</span>{{ $user_information->constitution }}</td>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">មុខតំណែង<span
                            style="margin-left:115px;">:</span>{{ $user_information->position_enteing_public_service }}
                    </td>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">ក្រសួង/ស្ថាប័ន<span
                            style="margin-left:98px;">:</span>{{ $user_information->ministry_enteing_public_service }}
                    </td>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">អង្គភាព<span
                            style="margin-left:131px;">:</span>{{ $user_information->economy_enteing_public_service }}
                    </td>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">ការិយាល័យ<span
                            style="margin-left:111px;">:</span>{{ $user_information->office_enteing_public_service }}
                    </td>
        ...
        <table class="table borderless">
            ...
            <thead>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">មុខតំណែង<span style="margin-left:99px;">:</span>
                        {{ $user_information->position_current_job_situation }}</td>

                </tr>

                <tr class="grid-row1">

                    <td class="grid-cell">កាលបរិច្ឆេទទទូលមុខតំណែងចុងក្រោយ<span style="margin-left:110px;">:</span>
                ...
                <tr class="grid-row1">
                    ...
                    <td class="grid-cell">អង្គភាព<span style="margin-left:115px;">:</span>
            ...
            @if (isset($additionalPCJ))
                ...
                @foreach ($additionalPCJ as $row)
                    <tr>
                        ...
                        <td style="font-size:12px">
                            <div style="width:100px;">{{ $row->position }}</div>
                        </td>

                        <td style="font-size:12px">
                            <div style="width:100px;">{{ $row->equivalent }}</div>
                        </td>

                        <td style="font-size:12px">
                            <div style="width:150px;">{{ $row->economy }}</div>
                        </td>
                    </tr>
                @endforeach
