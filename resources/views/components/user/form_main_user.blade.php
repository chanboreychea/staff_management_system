                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="phoneNumber" value="{{ $user->phoneNumber }}"
                                class="form-control" id="phoneNumber" placeholder="លេខទូរស័ព្ទ">
                            @error('phoneNumber')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="dateOfBirth" value="{{ $user->dateOfBirth }}"
                                ...
                                max="{{ date('Y-m-d') }}" id="dateOfBirth" placeholder="ថ្ងៃខែឆ្នាំកំណើត">
                            @error('dateOfBirth')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nationality" value="{{ $user->nationality }}"
                                class="form-control" id="nationality" placeholder="សញ្ជាត្តិ">
                            @error('nationality')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="pobAddress" value="{{ $user->pobAddress }}"
                                class="form-control" id="pobAddress" placeholder="ទីកន្លែងកំណើត">
                            @error('pobAddress')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
