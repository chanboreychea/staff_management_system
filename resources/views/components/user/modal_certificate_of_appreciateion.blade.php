    ...
    <form class="form-horizontal" action="{{ route('add_modal_certificate_of_appreciateion') }}" method="post" enctype="multipart/form-data">
        
        @csrf
        <center> <h4 class="form-top-header"><u> គ្រឿងឥស្សរិយយស ប័ណ្ណសរសើរ​ ទ័ណ្ខកម្មវិន័យ</u></h4></center>
        ...
        <div class="row" id="modal-body3" >
            ...
            @if(!empty($modalCertificate))
                ...
                @component('components.user.form_edit_modal_certificate_of_appreciateion',['modalCertificate'=>$modalCertificate])
...
$(document).ready(function(){
    ...
    $('.btn_click1').click(function(){
        ...
        $('#modal-body3').append('<div class="row4">' + formHtml + '<button class="btn btn-sm  btn-danger btn_remove float-sm-right">លុប</button></div>');
    });
