...
<br>
        ...
        <form class="form-horizontal" action="{{ route('add_ability_language') }}" method="post" enctype="multipart/form-data">
            
            @csrf
            <center> <h4 class="form-top-header"><u>សមត្ថភាពភាសាបរទេស</u></h4></center>
    ...
    $(document).ready(function(){
        ...
        $('.btn_click7').click(function(){
            ...
            $('#modal-body7').append('<div class="row7">' + formHtml + '<button class="btn btn-sm btn-danger btn_remove float-sm-right">លុប</button></div>');
        });
