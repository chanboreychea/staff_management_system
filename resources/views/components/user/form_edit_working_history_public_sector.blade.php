            ...
            @foreach ($workingHistoryPublicSector as $index => $working_histroy_public_sector)
                ...
                <tr class="additon_current_job">
                    ...
                    <td>
                        ...
                        value="{{ $working_histroy_public_sector['end_date'] ?? old('end_date.' . $index) }}">
                    ...
                    <td>
                        ...
                        required value="{{ $working_histroy_public_sector['ministry'] ?? old('ministry.' . $index) }}">
                            ...
                            <input type="text" class="form-control form-control-sm" id="textInput" 
                                placeholder="ក្រសួង/ស្ថាប័ន" name="ministry[]" 
                                id="hoverTextInput" 
                                 value="{{ $working_histroy_public_sector['ministry'] ?? old('ministry.' . $index) }}">
                    ...
                    <td>
                        <div class="container">
                            ...
                            value="{{ $working_histroy_public_sector['economy'] ?? old('economy.' . $index) }}">
                    ...
                    <td style=" vertical-align: middle;">
                        ...
                        <div class="container">
                            ...
                            placeholder="មុខតំណែង" name="position[]" 
                             ...
                             value="{{ $working_histroy_public_sector['position'] ?? old('position.' . $index) }}">
                    ...
                    <td  style=" vertical-align: middle;">
                        <div class="container">
                            ...
                            value="{{ $working_histroy_public_sector['other'] ?? old('other.' . $index) }}">
                        </div>         
                    </td>
