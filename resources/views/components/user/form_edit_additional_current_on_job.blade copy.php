                ...
                <tr class="additon_current_job">
                    ...
                    <td>
                        <div class="input_width">
                            ...
                            required value="{{ $job['position'] ?? old('position_additional_position_on_current_job.' . $index) }}">
                    ...
                    <td>
                        <div class="input_width">
                            ...
                            required value="{{ $job['equivalent'] ?? old('equivalent.' . $index) }}">
                    ...
                    <td>
                        <div class="input_width">
                            ...
                            required value="{{ $job['economy'] ?? old('economy_additional_position_on_current_job.' . $index) }}">
