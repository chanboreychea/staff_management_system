<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="date" name="date1[]" value="<?= old('date1.0') ?>" required class="form-control form-control-sm"
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control form-control-sm" placeholder="ស្ថាប័ន/អង្គភាព" name="economy1[]"
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control form-control-sm" name="decription1[]" placeholder="ខ្លឺមសារ"
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        <input type="type" class="form-control form-control-sm" name="type1[]" value="<?= old('type1.0') ?>"
            placeholder="ប្រភេទ">
    ...
    <div class="form-group col-md-6">
        ...
        <select name="status1[]" class="form-select form-select-sm">
            ...
            <option value="1" {{ in_array('1', old('status1', [])) ? 'selected' : '' }}>គ្រឿងឥស្សរិយយស ប័ណ្ណសរសើរ
            </option>
