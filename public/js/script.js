$(document).ready(function () {
    ...
    $("#btn1").click(function () {
        ...
        fetchData(
            userId,
            "#exLargeModal .modal-body1",
            "/user/user_form_information/"
        );
    });
    ...
    $("#btn3").click(function () {
        ...
        fetchData(
            userId,
            "#exLargeModal3 .modal-body3",
            "/user/modal_certificate_of_appreciateion/"
        );
    });
    ...
    $("#btn5").click(function () {
        ...
        fetchData(
            userId,
            "#exLargeModal5 .modal-body5",
            "/user/ability_language/"
        );
    });
